...
$requestBody = [
    ...
    'messages' => [
        [
            'role' => 'system',
            'content' => 'Tu es un expert en controle aérien et aéronautique et tu réponds en JSON avec un champ pour les altitudes, un champ pour les caps magnétiques, un champ pour l\'indicatif de l\'aeronef, pour le sens d\évolution verticale demandé à l\'aéronef, un champ pour les pressions'
        ],
        [
            'role' => 'user',
